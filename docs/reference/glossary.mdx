...
A blockchain compatible with the Ethereum Virtual Machine (for example Ethereum, Polygon, Base, Arc, Plasma, Tempo) where confidential assets settle. See [supported networks](/reference/supported-networks).
