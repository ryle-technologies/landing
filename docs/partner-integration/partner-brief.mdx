---
title: "Partner brief"
description: "A short overview for partners evaluating an integration. Kept intentionally high level."
sidebarTitle: "Partner brief"
---
...
For more depth, see the [platform overview](/partner-integration/platform-overview) or [technical brief](/partner-integration/technical-brief).
