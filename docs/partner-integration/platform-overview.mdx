...
description: "High-level overview for product, ops, and engineering teams evaluating a Ryle integration."
...
For engineering detail, see the [technical brief](/partner-integration/technical-brief).
