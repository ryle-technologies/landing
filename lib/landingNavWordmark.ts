/** Shared serif ramp for the Ryle wordmark (nav, closing block, etc.). */
export const landingNavWordmarkTypeClassName =
  "font-serif text-[28px] font-normal italic leading-none tracking-[-0.04em] text-foreground/90"
